...
Below I will introduce the data set which is available in base R, named '*trees*'. I will then investigate the data by performing a simple numerical summary and a basic plot.
